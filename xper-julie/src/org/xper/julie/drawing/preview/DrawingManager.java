...
public class DrawingManager implements Drawable{
	...
	int height;
	int width;
	int displayDur = 2000;	// msec display time
...
//			pngMaker.saveImage_db(stimObjIds.get(stimCounter),height,width);
	...
	protected void createContext(int heightmm, int widthmm) {
	...
	public void setDisplayDur(int displayDur) {
